...
export const PASSIVE_BLURBS: Record<string, string> = {
  ...
  reach: "Once a fight: the enemy's first decisive blow misses — you strike from out of range.",
  spikeshell: 'Retaliate for 2 damage whenever a foe’s blow lands.',
  skitter: '25% chance enemy strikes miss.',
  outpace: "Once a fight: the enemy's first decisive blow misses — you strike from out of range.",
