...
export const SPELLS: SpellInfo[] = [
  { id: "rot_surge", name: "Rot Surge", category: "buff", tier: 1, cooldownMin: 30, effect: "self_buff", desc: "+3 ATK next battle, and your Aggress oozes rot into the foe.", icon: "local_fire_department" },
  ...
  { id: "glowveil", name: "Glowveil", category: "buff", tier: 1, cooldownMin: 30, effect: "self_buff", desc: "+2 SPD and +15% flee next battle; a winning Feint reveals the foe's true intent.", icon: "flare" },
  { id: "scrap_toss", name: "Scrap Toss", category: "field", tier: 1, cooldownMin: 30, effect: "field_damage", range: 5, power: 8, desc: "Hurl city scrap at a rival. Cannot drop a target below 1 HP.", icon: "construction" },
  { id: "spore_bolt", name: "Spore Bolt", category: "field", tier: 1, cooldownMin: 20, effect: "field_damage", range: 6, power: 12, desc: "A puff of caustic spores at range. Cannot drop a target below 1 HP.", icon: "flash_on" },
  ...
  { id: "harden_shell", name: "Harden Shell", category: "buff", tier: 1, cooldownMin: 20, effect: "self_buff", desc: "+2 DEF next battle, and you knit 3 HP each round you win in Guard.", icon: "shield" },
  ...
  { id: "spore_burst", name: "Spore Burst", category: "field", tier: 3, cooldownMin: 30, effect: "field_damage", range: 8, power: 30, desc: "A detonation of spores at range. Cannot drop a target below 1 HP.", icon: "coronavirus" },
  ...
  { id: "queens_bane", name: "Queen's Bane", category: "boss", tier: 3, cooldownMin: 60, effect: "boss_strike", power: 15, desc: "Sear the Queen or a lair boss, from anywhere. Cannot drop a target below 1 HP — finish it in person.", icon: "gavel" },
  ...
  { id: "ember_fleck", name: "Ember Fleck", category: "field", tier: 1, cooldownMin: 15, effect: "field_damage", range: 4, power: 10, desc: "A quick fleck of ember at close range. Cannot drop a target below 1 HP.", icon: "whatshot" },
  { id: "necrotic_lance", name: "Necrotic Lance", category: "field", tier: 2, cooldownMin: 28, effect: "field_damage", range: 9, power: 16, desc: "A long lance of necrotic rot. Cannot drop a target below 1 HP.", icon: "colorize" },
  { id: "withering_gout", name: "Withering Gout", category: "field", tier: 3, cooldownMin: 26, effect: "field_damage", range: 6, power: 26, desc: "A gout of withering decay. Cannot drop a target below 1 HP.", icon: "coronavirus" },
  ...
  { id: "sear_throne", name: "Sear the Throne", category: "boss", tier: 3, cooldownMin: 60, effect: "boss_strike", power: 22, desc: "Sear the Queen or a lair boss from anywhere — the only spell that can land the killing blow at range.", icon: "local_fire_department" },
