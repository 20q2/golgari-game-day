...
SPELLS = {
    ...
    'rot_surge':   {'name': 'Rot Surge', 'category': 'buff', 'tier': 1, 'cooldownSteps': 6,
    ...
    'bone_chill':  {'name': 'Bone Chill', 'category': 'field', 'tier': 1, 'cooldownSteps': 6,
    ...
    'bog_snare':   {'name': 'Bog Snare', 'category': 'field', 'tier': 1, 'cooldownSteps': 6,
    ...
    'glowveil':    {'name': 'Glowveil', 'category': 'buff', 'tier': 1, 'cooldownSteps': 6,
    ...
    'scrap_toss':  {'name': 'Scrap Toss', 'category': 'field', 'tier': 1, 'cooldownSteps': 6,
    ...
    'spore_bolt':  {'name': 'Spore Bolt', 'category': 'field', 'tier': 1, 'cooldownSteps': 4,
    ...
    'mend_flesh':  {'name': 'Mend Flesh', 'category': 'buff', 'tier': 1, 'cooldownSteps': 4,
                    'effect': 'self_heal', 'power': 12,
                    'icon': 'healing', 'desc': 'Knit your wounds.',
                    'blurb': 'Knit your wounds: restore 12 HP.'},
    'harden_shell': {'name': 'Harden Shell', 'category': 'buff', 'tier': 1, 'cooldownSteps': 4,
    ...
    'skitter_step': {'name': 'Skitter Step', 'category': 'traversal', 'tier': 1,
                     'cooldownSteps': 5, 'effect': 'fate_die', 'maxValue': 3,
    ...
    'sinkstep':    {'name': 'Sinkstep', 'category': 'traversal', 'tier': 1,
                    'cooldownSteps': 5, 'effect': 'fate_die', 'maxValue': 1,
    ...
    'rot_bolt':    {'name': 'Rot Bolt', 'category': 'field', 'tier': 2, 'cooldownSteps': 5,
    ...
    'weaken_hex':  {'name': 'Weaken Hex', 'category': 'field', 'tier': 2, 'cooldownSteps': 5,
    ...
    'fate_die':    {'name': 'Fate Die', 'category': 'traversal', 'tier': 2,
                    'cooldownSteps': 8, 'effect': 'fate_die',
    ...
    'spore_burst': {'name': 'Spore Burst', 'category': 'field', 'tier': 3, 'cooldownSteps': 6,
    ...
    'deep_step':   {'name': 'Deep Step', 'category': 'traversal', 'tier': 3,
                    'cooldownSteps': 6, 'effect': 'teleport', 'range': 6,
    ...
    'queens_bane': {'name': "Queen's Bane", 'category': 'boss', 'tier': 3,
                    'cooldownSteps': 12, 'effect': 'boss_strike', 'power': 15,
                    'icon': 'gavel',
    ...
    'ember_fleck':  {'name': 'Ember Fleck', 'category': 'field', 'tier': 1, 'cooldownSteps': 3,
    ...
    'necrotic_lance': {'name': 'Necrotic Lance', 'category': 'field', 'tier': 2, 'cooldownSteps': 6,
    ...
    'withering_gout': {'name': 'Withering Gout', 'category': 'field', 'tier': 3, 'cooldownSteps': 5,
    ...
    'renewing_bloom': {'name': 'Renewing Bloom', 'category': 'buff', 'tier': 2, 'cooldownSteps': 5,
    ...
    'deep_mend':    {'name': 'Deep Mend', 'category': 'buff', 'tier': 3, 'cooldownSteps': 6,
                     'effect': 'self_heal', 'power': 34,
                     'icon': 'healing', 'desc': 'Deep restorative mycelium knits you whole.',
                     'blurb': 'Deep mycelium knits you whole.'},
    'sear_throne':  {'name': 'Sear the Throne', 'category': 'boss', 'tier': 3, 'cooldownSteps': 12,
    ...
    'shadowstep':   {'name': 'Shadowstep', 'category': 'traversal', 'tier': 2, 'cooldownSteps': 5,
                     'effect': 'teleport', 'range': 3,
                     'icon': 'nightlight', 'desc': 'Blink to any space within 3 steps.',
                     'blurb': 'You step through the dark.'},
    'savage_roar':  {'name': 'Savage Roar', 'category': 'buff', 'tier': 2, 'cooldownSteps': 5,
    ...
    'sap_vigor':    {'name': 'Sap Vigor', 'category': 'field', 'tier': 2, 'cooldownSteps': 5,
    ...
    'rust_curse':   {'name': 'Rust Curse', 'category': 'field', 'tier': 3, 'cooldownSteps': 6,
    ...
    'acorn_fury':   {'name': 'Acorn Fury', 'category': 'buff', 'tier': 1, 'cooldownSteps': 3,
