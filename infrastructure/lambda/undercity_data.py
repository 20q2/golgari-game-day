...
GEAR = {
    ...
    'wurm_tooth':   {'name': 'Wurm Barb',   'slot': 'fang', 'tier': 3, 'cost': 80, 'atk': 6, 'spd': 1, 'rider': 'deep_biter'},
    'ravening_maw': {'name': 'Ravening Fang', 'slot': 'fang', 'tier': 3, 'cost': 85, 'atk': 5, 'spd': 1, 'rider': 'rabid'},
    # Fang — new rarity rungs (complete the barbed/bloodfang/deep_biter/rabid/gutcleaver ladders)
    'cutter_fang':     {'name': 'Cutter Barb',     'slot': 'fang', 'tier': 1, 'cost': 22, 'atk': 2, 'rider': 'deep_biter'},
    'feral_nip':       {'name': 'Feral Fang',       'slot': 'fang', 'tier': 1, 'cost': 23, 'atk': 2, 'rider': 'rabid'},
    ...
    'wyrm_venomtooth': {'name': 'Wyrmvenom Fang', 'slot': 'fang', 'tier': 3, 'cost': 82, 'atk': 6, 'spd': 1, 'rider': 'barbed'},
    'vampiric_maw':    {'name': 'Vampiric Fang',    'slot': 'fang', 'tier': 3, 'cost': 83, 'atk': 6, 'spd': 1, 'rider': 'bloodfang'},
    'gravecleaver':    {'name': 'Gravecleaver',    'slot': 'fang', 'tier': 3, 'cost': 84, 'atk': 6, 'rider': 'gutcleaver'},
    # Carapace — Guard riders
    'chitin_scrap': {'name': 'Chitin Carapace', 'slot': 'carapace', 'tier': 1, 'cost': 20, 'def': 2, 'rider': 'thick'},
    ...
    'ironshell_bulwark': {'name': 'Ironshell Plate', 'slot': 'carapace', 'tier': 3, 'cost': 85, 'def': 5, 'maxHp': 6, 'rider': 'bulwark'},
    ...
    'barricade_shell':   {'name': 'Barricade Plate', 'slot': 'carapace', 'tier': 1, 'cost': 23, 'def': 2, 'rider': 'bulwark'},
    ...
    'colossus_shell':    {'name': 'Colossus Carapace',  'slot': 'carapace', 'tier': 3, 'cost': 82, 'def': 5, 'maxHp': 6, 'rider': 'thick'},
    'bramble_aegis':     {'name': 'Bramble Aegis',   'slot': 'carapace', 'tier': 3, 'cost': 83, 'def': 5, 'maxHp': 6, 'rider': 'bramble'},
    'overgrown_bulwark': {'name': 'Sunleaf Bulwark', 'slot': 'carapace', 'tier': 3, 'cost': 84, 'def': 5, 'maxHp': 6, 'rider': 'mossback'},
    ...
    'quartz_charm':   {'name': "Fool's Charm",   'slot': 'charm', 'tier': 1, 'cost': 20, 'spd': 1, 'rider': 'trickster'},
    ...
    'seer_charm':     {'name': "Seer's Charm",     'slot': 'charm', 'tier': 2, 'cost': 50, 'spd': 1, 'rider': 'seer', 'readBonus': 0.30},
    ...
    'glass_eye':        {'name': "Seer's Glass",       'slot': 'charm', 'tier': 1, 'cost': 24, 'spd': 1, 'rider': 'seer', 'readBonus': 0.15},
...
CONSUMABLES = {
    ...
    # ── Tier 2 · Rare ────────────────────────────────────────────────────────
    # Recall to any home-biome Gate and LAND on it — which full-heals you. The
    # answer to being stranded far from a Gate on low HP with rolls still banked
    # (exactly how a player was lost in session 20260808-182231). Deliberately a
    # retreat, not an advance: Gates sit in the home rings, away from the deep
    # content, so recalling always costs you ground.
    'gatestone':    {'name': 'Gatestone', 'tier': 2, 'recall': 'gate',
                     'blurb': 'Recall to any home Gate and land on it — mending you fully.'},
...
# Doubled 2026-09-09 after playtest: at the old rate a tier-1 utility like
# Skitter Step came up every 1-2 turns, which is the SQUIRREL's niche. Spell
# Haste halves these, so a squirrel now casts at the old everyone-else rate.
...
SPELLS = {
    ...
    'rot_surge':   {'name': 'Rot Surge', 'category': 'buff', 'tier': 1, 'cooldownSteps': 12,
    ...
    'bone_chill':  {'name': 'Bone Chill', 'category': 'field', 'tier': 1, 'cooldownSteps': 12,
    ...
    'bog_snare':   {'name': 'Bog Snare', 'category': 'field', 'tier': 1, 'cooldownSteps': 12,
    ...
    'glowveil':    {'name': 'Glowveil', 'category': 'buff', 'tier': 1, 'cooldownSteps': 12,
    ...
    'scrap_toss':  {'name': 'Scrap Toss', 'category': 'field', 'tier': 1, 'cooldownSteps': 12,
    ...
    'spore_bolt':  {'name': 'Spore Bolt', 'category': 'field', 'tier': 1, 'cooldownSteps': 8,
    ...
    'mend_flesh':  {'name': 'Mend Flesh', 'category': 'buff', 'tier': 1, 'cooldownSteps': 8,
                    'effect': 'self_heal', 'power': 12,
                    'icon': 'healing', 'desc': 'Knit your wounds.',
                    'blurb': 'Knit your wounds: restore 12 HP.'},
    'harden_shell': {'name': 'Harden Shell', 'category': 'buff', 'tier': 1, 'cooldownSteps': 8,
    ...
    'skitter_step': {'name': 'Skitter Step', 'category': 'traversal', 'tier': 1,
                     'cooldownSteps': 10, 'effect': 'fate_die', 'maxValue': 3,
    ...
    'sinkstep':    {'name': 'Sinkstep', 'category': 'traversal', 'tier': 1,
                    'cooldownSteps': 10, 'effect': 'fate_die', 'maxValue': 1,
    ...
    'rot_bolt':    {'name': 'Rot Bolt', 'category': 'field', 'tier': 2, 'cooldownSteps': 10,
    ...
    'weaken_hex':  {'name': 'Weaken Hex', 'category': 'field', 'tier': 2, 'cooldownSteps': 10,
    ...
    'mycelial_recall': {'name': 'Mycelial Recall', 'category': 'traversal', 'tier': 2,
                        'cooldownSteps': 18, 'effect': 'recall',
    ...
    'fate_die':    {'name': 'Fate Die', 'category': 'traversal', 'tier': 2,
                    'cooldownSteps': 16, 'effect': 'fate_die',
    ...
    'spore_burst': {'name': 'Spore Burst', 'category': 'field', 'tier': 3, 'cooldownSteps': 12,
    ...
    'deep_step':   {'name': 'Deep Step', 'category': 'traversal', 'tier': 3,
                    'cooldownSteps': 12, 'effect': 'teleport', 'range': 6,
    ...
    'queens_bane': {'name': "Queen's Bane", 'category': 'boss', 'tier': 3,
                    'cooldownSteps': 24, 'effect': 'boss_strike', 'power': 15,
                    'icon': 'gavel',
    ...
    'ember_fleck':  {'name': 'Ember Fleck', 'category': 'field', 'tier': 1, 'cooldownSteps': 6,
    ...
    'necrotic_lance': {'name': 'Necrotic Lance', 'category': 'field', 'tier': 2, 'cooldownSteps': 12,
    ...
    'withering_gout': {'name': 'Withering Gout', 'category': 'field', 'tier': 3, 'cooldownSteps': 10,
    ...
    'renewing_bloom': {'name': 'Renewing Bloom', 'category': 'buff', 'tier': 2, 'cooldownSteps': 10,
    ...
    'deep_mend':    {'name': 'Deep Mend', 'category': 'buff', 'tier': 3, 'cooldownSteps': 12,
                     'effect': 'self_heal', 'power': 34,
                     'icon': 'healing', 'desc': 'Deep restorative mycelium knits you whole.',
                     'blurb': 'Deep mycelium knits you whole.'},
    'sear_throne':  {'name': 'Sear the Throne', 'category': 'boss', 'tier': 3, 'cooldownSteps': 24,
    ...
    'shadowstep':   {'name': 'Shadowstep', 'category': 'traversal', 'tier': 2, 'cooldownSteps': 10,
                     'effect': 'teleport', 'range': 3,
                     'icon': 'nightlight', 'desc': 'Blink to any space within 3 steps.',
                     'blurb': 'You step through the dark.'},
    'savage_roar':  {'name': 'Savage Roar', 'category': 'buff', 'tier': 2, 'cooldownSteps': 10,
    ...
    'sap_vigor':    {'name': 'Sap Vigor', 'category': 'field', 'tier': 2, 'cooldownSteps': 10,
    ...
    'rust_curse':   {'name': 'Rust Curse', 'category': 'field', 'tier': 3, 'cooldownSteps': 12,
    ...
    'acorn_fury':   {'name': 'Acorn Fury', 'category': 'buff', 'tier': 1, 'cooldownSteps': 6,
